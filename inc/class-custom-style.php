    ...
    Class Lusion_Custom_Style
    {
        ...
        function primary_color_css()
        {
            ...
            if (isset($color) && $color !== '') {
                ...
                .woocommerce div.entry-summary form.cart .woocommerce-grouped-product-list.group_table tbody td .quantity .qty-number:hover span.increase-qty,.post-meta-info a:hover,.post-name a:hover,
                .woocommerce-cart-form .actions button.button, .woocommerce-cart-form .actions button.button:disabled, .woocommerce-cart-form .actions button.button:disabled[disabled],.page.woocommerce-cart .cart-right .woocommerce-shipping-calculator button,
                    ...
                    .breadcrumb li,.languges-flags .lang-1:hover i,
                    .woocommerce-downloads.woocommerce-account .woocommerce-MyAccount-content .woocommerce-info a.button:hover,
                    .breadcrumb li a:hover,.product-style-2 .product-grid .product-top > .wishlist-btn a:hover,
                    .woocommerce-loop-product__title a:hover,.post-name a:hover,.sc-instagram .content a.user-name:hover,
                    .blog-shortcode.grid-style5 .read_more a,.content-filter.languges>ul li a:hover,.product-style-2:not(.product-action-horizontal-middle):not(.product-action-horizontal-bottom) .product-grid .product-top .product-action .group-action a.button:hover:before,
                     ...
                     .elementor-icon:hover,.post-type-archive-portfolio .portfolio-container.layout1 .load-item .item .portfolio_body .title-category .portfolio_title a:hover,
                      ...
                      .portfolio-single .pagination-link .nav-previous a:last-child:hover,
                       ...
                       .active-sidebar .comment-author-link,
                        ...
                        .product-style-2.product-action-horizontal-bottom .product-grid .product-top .product-action .group-action a.button,
                        .product-style-2.product-action-horizontal-bottom .product-grid .product-top .product-action .action-item .add-cart-btn a:hover:before,
                        .product-style-2.product-action-horizontal-bottom .product-grid .product-top .product-action a,
                        .product-style-2.product-action-horizontal-bottom .product-action .yith-wcwl-wishlistaddedbrowse a:before, 
                        .product-style-2.product-action-horizontal-bottom .product-action .yith-wcwl-wishlistexistsbrowse a:before,
                        ...
                        .elementor-custom-embed-play .eicon-play:before,.lookbook-inner .repeater-item .product-item .content-product .title-price .price,
                        ...
                        .product-style-2 div.woocommerce ul.products li.product .button.loading::after,
                       ...
                       .popup-account form.woocommerce-form.woocommerce-form-login button.button:hover,
                        ...
                        .header-language-text .language-content__text .content-filter.languges > ul li a:hover,
                         ...
                         .sub-cart a.button.checkout:focus,.product-style-2.product-action-horizontal-bottom div.woocommerce ul.products .product-content .product-desc .product-action .add-cart .add-cart-btn a:before,
                         ...
                         .product-action-horizontal-bottom.product-style-2 div.woocommerce ul.products li.product .button.loading:hover::after,
                         .apr-advance-tabs.apr-tabs-vertical .apr-tabs-nav>.apr-tab-top-icon>.item-tab.active, .apr-advance-tabs.apr-tabs-vertical .apr-tabs-nav>.apr-tab-top-icon>.item-tab:hover, .apr-advance-tabs.apr-tabs-vertical .apr-tabs-nav>.apr-tab-top-icon>.item-tab.active-default,
                    ...
                    .product-style-2.product-action-horizontal-middle .product-grid .product-top .product-action .action-item a:hover,
                    .tooltip-inner,
					.scroll-to-top,
					.product-style-2.product-action-horizontal-bottom .product-grid .product-top .product-action .group-action a.button:hover,
                    ...
                    .blog-shortcode.grid-style4 .watch-video i,
                    .product-style-6.apr-product .slick-slider .slick-arrow i:hover,
					.product-style-6.apr-product .slick-slider .slick-arrow i:focus,
                    .blog-shortcode.grid-style4 .watch-video i,
                    .blog-shortcode.grid-style5 .read_more a:before,
                    ...
                    .apr-product .slick-slider .slick-arrow i:focus,
                     ...
                     .product-style-2.product-action-horizontal-bottom .product-grid .product-top .product-action .action-item .add-cart-btn a,
                     .product-style-2.product-action-horizontal-bottom .product-grid .product-top .product-action a:hover,
                    ...
                    .product-style.product-style-2.product-action-horizontal-bottom.product-style-7 .product-grid .product-top .product-action .action-item .add-cart-btn a:hover,
                    ...
                    .blog-list-style-3.list_post_sticky.blog-list .blog-item.blog-has-img .blog-post-info .category-post a, .blog-list-style-3.list_post_sticky.blog-list .blog-item.blog-item.post-image .blog-post-info .category-post a, 
                   ...
                   .elementor-icon-box-icon .elementor-icon:hover,
                    ...
                    .product-style-2.middle-has-wishlist.wishlist--bottom .wishlist-btn .tooltip-custom::after, .product-style-2.middle-has-wishlist.wishlist--top .wishlist-btn .tooltip-custom::after,
                    .tooltip-custom::after{
                            border-color: $color transparent transparent transparent;
                    }
                    
                    .product-style-1 .tooltip-custom::after, 
                    .product-style-2:not(.product-action-horizontal-middle):not(.product-action-horizontal-bottom) .tooltip-custom::after, 
                    ...
                    .rtl .product-style-2:not(.product-action-horizontal-middle):not(.product-action-horizontal-bottom) .tooltip-custom::after, 
                    ...
                    .woocommerce-checkout #payment #place_order:hover,.product-style.product-style-2.product-action-horizontal-bottom.product-style-7 .product-grid .product-top .product-action .add-cart-btn a,
                    .apr-product .loadmore-product .view-more-button:hover, .apr-product .loadmore-product .view-more-button:focus,
                    ...
                    .apr-product .loadmore-product .view-more-button:hover, .apr-product .loadmore-product .view-more-button:focus,
                    .woocommerce .product.product-type-grouped .single_2 div.entry-summary .yith-wcwl-add-to-wishlist a:hover,
                    .product-style.product-style-2.product-action-horizontal-bottom.product-style-7 .product-grid .product-top .product-action .add-cart-btn a,
					...
					@media (min-width: 1025px){
                        ...
                        .apr-product:not(.product-default):not(.product-style-2) div.woocommerce ul.products .product-desc .product-action .action-item .add-cart-btn a:before, 
                        .btn:before, 
                    ...
                    @media (max-width: 1024px){
                        ...
                        .product-style-2.middle-has-wishlist .product-grid .product-content .product-desc .product-action .add-cart .add-cart-btn a:before,
                        .woo-list-category .list-cate-title:hover,
                        .woo-list-category ul.children-cate li a:hover,
                        .product-action-horizontal-bottom.product-style-2 div.woocommerce ul.products li.product .button.loading::after{
                            color: $color;
                        }
                    }
                    ...
                    @media (min-width: 768px){
                        ...
                        .product-style-4 div.woocommerce ul.products .product-content .product-desc .product-action .group-action .action-item a:hover ,
                        ...
                        .product-style-4 div.woocommerce ul.products.product-grid .product-content .product-desc .product-action .group-action .action-item a:hover{
                            background-color: $color;
                        }
                    }
        ...
        function header()
        {
            ...
            if (is_singular('header')) {
                ...
                if (!empty($header_type) && $header_type !== 'default') {
                    $id = lusion_get_id_by_slug(lusion_get_meta_value('header_type'));
                } else {
                    $id = lusion_get_id_by_slug(Lusion::setting('choose_header_builder'));
                }
            }
