...
$block_name = lusion_get_save_template();
...
Lusion_Kirki::add_field( 'theme', array(
	...
	'label'       => esc_html__( 'Show/Hide Sitcky Product', 'lusion' ),
...
Lusion_Kirki::add_field('theme', array(
    ...
    'default' => wp_kses(__('Related Products', 'lusion'),
        array(
            'a' => array(
                'href' => array(),
                'title' => array(),
...
Lusion_Kirki::add_field('theme', array(
    ...
    'default' => wp_kses(__('Upsell Products', 'lusion'),
        array(
            'a' => array(
                'href' => array(),
                'title' => array(),
