...
$class_thumbnails='';
if ($lusion_product_thumbnails === 'vertical') {
...
$sticky_product = '';
$sticky_single_product = get_post_meta(get_the_ID(), 'sticky_product', true);
if($sticky_single_product == 1 ){
	$sticky_product = $sticky_single_product;
}else{
	$sticky_product = Lusion::setting('single_sticky_product');
}
			...
			<div class="sitcky-wapper container">
				...
				<div class="sitcky-right">
					...
					<?php if (class_exists('YITH_WCWL') && Lusion::setting('product_wishlist')) : ?>
						<?php echo lusion_wishlist_custom(); ?>
					<?php endif; ?>
				</div>
			</div>
			<?php
