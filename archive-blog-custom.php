				    ...
				    <?php elseif(get_post_format() == 'gallery'): ?>
				     ...
				     <?php elseif(get_post_format() == 'image'): ?>
				        <?php if (has_post_thumbnail()): ?>
			                ...
			                <div class="blog-img ">
			                    <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" >
			                        <img class="no-lazyload" src="<?php echo esc_url( $image_url ); ?>" alt="<?php the_title_attribute(); ?>"/>
			                    </a>
			                </div>
				        <?php endif;?>
				    <?php else: ?>
	    ...
	    <div class="load-item featured-post">
		    <div class="container">
		    	<div class="row">
		    		...
		    		<?php }?>
		    	<?php if ( $the_query_featured->have_posts() ) : while ($the_query_featured->have_posts()) : $the_query_featured->the_post(); $do_not_duplicate = $post->ID; 
			            $format_class = '';
			            if( get_post_format() ==='quote'){
			                $format_class = 'post-quote';
			            } elseif( get_post_format() ==='link'){
			       	 ...
			       	 <div class=" col-md-4 item animate-top item-page<?php echo esc_attr($current_page); ?>">
			   	 		<div class="blog-item  <?php echo esc_attr($format_class);?>  <?php if ( !has_post_thumbnail() &&  get_post_format() !=='quote' && get_post_format() !=='link' && get_post_format() !=='audio' ) {echo 'no-image';}?> <?php if ( get_post_format() ==='gallery' ){ echo 'item-gallery';} ?> " >
