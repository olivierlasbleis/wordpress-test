...
<head>
    ...
    <?php
        ...
        if(is_plugin_active( $pluginPath )): ?>
            <link rel="preload" href="<?php echo plugin_dir_url('/elementor/assets/lib/font-awesome/webfonts/fa-brands-400.woff2') ?>fa-brands-400.woff2" as="font" type="font/woff2" crossorigin="anonymous" />
     <?php endif; ?>   
     <?php
        $pluginPathRev =  'revslider/revslider.php';
        if(is_plugin_active( $pluginPathRev )): ?>
            <link rel="preload" href="<?php echo plugin_dir_url('/revslider/public/assets/fonts/revicons/revicons.woff?5510888') ?>revicons.woff?5510888" as="font" type="font/woff" crossorigin="anonymous" />
     <?php endif; ?>
    <?php wp_head(); ?>
</head>
<?php
    ...
    <div id="page" <?php lusion_page_class();?>>
        ...
        <div id="site-main" class="wrapper">
            <?php if($lusion_site_layout == 'full-width') :?>
                <div class="container">
            <?php elseif ($lusion_site_layout == 'wide' || $lusion_site_layout == 'boxed'): ?>
